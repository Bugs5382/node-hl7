  ...
  fields: [
    ...
    },
    {
      ...
      components: [
        ...
        { num: 2, name: "Relational Operator", hl7Type: "ID", length: { max: 2 }, table: 209, usage: "O", rpt: "1" },
        { num: 3, name: "Value", hl7Type: "ST", length: { max: 199 }, usage: "O", rpt: "1" },
        { num: 4, name: "Relational Conjunction", hl7Type: "ID", length: { max: 3 }, table: 210, usage: "O", rpt: "1" },
      ],
    },
  ],
};
