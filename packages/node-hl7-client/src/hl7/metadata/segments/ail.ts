 ...
 * (https://hl7-definition.caristix.com/v2/HL7v2.X/Segments/AIL)
 * by scripts/generate-segment-specs.mjs. Do not edit by hand — re-run the
 * generator instead.
 *
 * @since 4.0.0
 */
export const AIL_SPEC: SegmentSpec = {
  name: "AIL",
  ...
  fields: [
    ...
    },
    {
      ...
      hl7Type: "CWE",
      table: 305,
      usage: {"2.3":"R","2.3.1":"R","2.4":"R","2.5":"D","2.5.1":"D","2.6":"D","2.7":"D","2.7.1":"D","2.8":"D"},
    },
    {
      num: 5,
      name: "Location Group",
