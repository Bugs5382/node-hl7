...
export class HL7_2_1 extends HL7_BASE {
  ...
  protected _buildNTE(props: Partial<HL7_2_1_NTE>) {
    ...
    this._validatorSetValue("1", props.nte_1, { length: { min: 1, max: 4 } });
    this._validatorSetValue("2", props.nte_2 || props.sourceOfComment, {
      length: { min: 1, max: 8 },
    });
    this._validatorSetValue("3", props.nte_3 || props.comment, {
  ...
  protected _buildOBR(props: Partial<HL7_2_1_OBR>) {
    ...
    this._validatorSetValue("1", props.obr_1, { length: { min: 1, max: 4 } });
    this._validatorSetValue("2", props.obr_2 || props.placerOrderNumber, {
      length: { min: 1, max: 75 },
    });
    this._validatorSetValue("3", props.obr_3 || props.fillerOrderNumber, {
      length: { min: 1, max: 75 },
    });
    this._validatorSetValue("4", props.obr_4 || props.universalServiceId, {
      required: true,
      length: { min: 1, max: 200 },
    });
    this._validatorSetValue("5", props.obr_5, { length: { min: 1, max: 2 } });
    this._validatorSetValue(
      "6",
    ...
    this._validatorSetValue("9", props.obr_9 || props.collectionVolume, {
      length: { min: 1, max: 20 },
    });
    this._validatorSetValue("10", props.obr_10, {
      length: { min: 1, max: 60 },
    });
    this._validatorSetValue("11", props.obr_11, { length: 1 });
    this._validatorSetValue("12", props.obr_12, {
      length: { min: 1, max: 60 },
    });
    this._validatorSetValue("13", props.obr_13, {
    ...
    this._validatorSetValue("15", props.obr_15 || props.specimenSource, {
      length: { min: 1, max: 300 },
    });
    this._validatorSetValue("16", props.obr_16 || props.orderingProvider, {
      length: { min: 1, max: 80 },
    });
    this._validatorSetValue("17", props.obr_17, {
      length: { min: 1, max: 40 },
    });
    this._validatorSetValue("18", props.obr_18, {
      length: { min: 1, max: 60 },
    });
    this._validatorSetValue("19", props.obr_19, {
      length: { min: 1, max: 60 },
    });
    this._validatorSetValue("20", props.obr_20, {
      length: { min: 1, max: 60 },
    });
    this._validatorSetValue("21", props.obr_21, {
      length: { min: 1, max: 60 },
    });
    this._validatorSetValue(
      "22",
    ...
    this._validatorSetValue("23", props.obr_23, {
      length: { min: 1, max: 40 },
    });
    this._validatorSetValue(
      "24",
    ...
    this._validatorSetValue("25", props.obr_25 || props.resultStatus, {
  ...
  protected _buildOBX(props: Partial<HL7_2_1_OBX>) {
    ...
    this._validatorSetValue("1", props.obx_1, { length: { min: 1, max: 4 } });
    this._validatorSetValue("2", props.obx_2 || props.valueType, {
    ...
    this._validatorSetValue("4", props.obx_4 || props.observationSubId, {
      length: { min: 1, max: 20 },
    });
    this._validatorSetValue("5", props.obx_5 || props.observationValue, {
      length: { min: 1, max: 65536 },
    });
    this._validatorSetValue("6", props.obx_6 || props.units, {
      length: { min: 1, max: 60 },
    });
    this._validatorSetValue("7", props.obx_7 || props.referencesRange, {
      length: { min: 1, max: 60 },
    });
    this._validatorSetValue("8", props.obx_8 || props.abnormalFlags, {
      allowedValues: this._table_0078,
      length: { min: 1, max: 5 },
    });
    this._validatorSetValue("9", props.obx_9, {
      length: { min: 1, max: 5 },
    });
    this._validatorSetValue("10", props.obx_10, { length: 2 });
    this._validatorSetValue(
      "11",
  ...
  protected _buildORC(props: Partial<HL7_2_1_ORC>) {
    ...
    this._validatorSetValue("1", props.orc_1 || props.orderControl, {
      required: true,
      allowedValues: this._table_0119,
      length: { min: 1, max: 2 },
    });
    this._validatorSetValue("2", props.orc_2 || props.placerOrderNumber, {
      length: { min: 1, max: 75 },
    });
    this._validatorSetValue("3", props.orc_3 || props.fillerOrderNumber, {
      length: { min: 1, max: 75 },
    });
    this._validatorSetValue("4", props.orc_4, {
      length: { min: 1, max: 75 },
    });
    this._validatorSetValue("5", props.orc_5 || props.orderStatus, {
      length: { min: 1, max: 2 },
    });
    this._validatorSetValue("6", props.orc_6 || props.responseFlag, {
      allowedValues: this._table_0121,
      length: 1,
    });
    this._validatorSetValue("7", props.orc_7, {
      length: { min: 1, max: 200 },
    });
    this._validatorSetValue("8", props.orc_8, {
      length: { min: 1, max: 200 },
    });
    this._validatorSetValue(
      "9",
    ...
    this._validatorSetValue("10", props.orc_10 || props.enteredBy, {
      length: { min: 1, max: 80 },
    });
    this._validatorSetValue("11", props.orc_11 || props.verifiedBy, {
      length: { min: 1, max: 80 },
    });
    this._validatorSetValue("12", props.orc_12 || props.orderingProvider, {
      length: { min: 1, max: 80 },
    });
    this._validatorSetValue("13", props.orc_13, {
      length: { min: 1, max: 80 },
    });
    this._validatorSetValue("14", props.orc_14 || props.callBackPhoneNumber, {
      length: { min: 1, max: 40 },
    });
  }
  ...
  protected _buildPID(props: Partial<HL7_2_1_PID>) {
    ...
    this._validatorSetValue("1", props.pid_1, { length: { min: 1, max: 4 } });
    this._validatorSetValue("2", props.pid_2 || props.patientIdExternal, {
      length: { min: 1, max: 16 },
    });
    this._validatorSetValue("3", props.pid_3 || props.patientIdInternal, {
      required: true,
      length: { min: 1, max: 20 },
    });
    this._validatorSetValue("4", props.pid_4 || props.alternatePatientId, {
      length: { min: 1, max: 12 },
    });
    this._validatorSetValue("5", props.pid_5 || props.patientName, {
      required: true,
      length: { min: 1, max: 48 },
    });
    this._validatorSetValue("6", props.pid_6 || props.mothersMaidenName, {
      length: { min: 1, max: 30 },
    });
    this._validatorSetValue(
      "7",
    ...
    this._validatorSetValue("8", props.pid_8 || props.sex, {
      allowedValues: this._table_0001,
      length: 1,
    });
    this._validatorSetValue("9", props.pid_9 || props.patientAlias, {
      length: { min: 1, max: 48 },
    });
    this._validatorSetValue("10", props.pid_10 || props.race, {
      length: { min: 1, max: 1 },
    });
    this._validatorSetValue("11", props.pid_11 || props.patientAddress, {
      length: { min: 1, max: 106 },
    });
    this._validatorSetValue("12", props.pid_12 || props.countyCode, {
      length: { min: 1, max: 4 },
    });
    this._validatorSetValue("13", props.pid_13 || props.phoneNumberHome, {
      length: { min: 1, max: 40 },
    });
    this._validatorSetValue("14", props.pid_14 || props.phoneNumberBusiness, {
      length: { min: 1, max: 40 },
    });
    this._validatorSetValue("15", props.pid_15 || props.language, {
      length: { min: 1, max: 25 },
    });
    this._validatorSetValue("16", props.pid_16 || props.maritalStatus, {
      allowedValues: this._table_0002,
      length: 1,
    });
    this._validatorSetValue("17", props.pid_17 || props.religion, {
      length: { min: 1, max: 3 },
    });
    this._validatorSetValue("18", props.pid_18 || props.patientAccountNumber, {
      length: { min: 1, max: 20 },
    });
    this._validatorSetValue("19", props.pid_19 || props.ssn, {
      length: { min: 1, max: 16 },
    });
  }
  ...
  protected _buildPV1(props: Partial<HL7_2_1_PV1>) {
    ...
    this._validatorSetValue("1", props.pv1_1, { length: { min: 1, max: 4 } });
    this._validatorSetValue("2", props.pv1_2 || props.patientClass, {
      required: true,
    ...
    this._validatorSetValue("4", props.pv1_4 || props.admissionType, {
      allowedValues: this._table_0007,
      length: 1,
    });
    this._validatorSetValue("5", props.pv1_5 || props.preadmitNumber, {
      length: { min: 1, max: 20 },
    });
    this._validatorSetValue("6", props.pv1_6 || props.priorPatientLocation, {
      length: { min: 1, max: 12 },
    });
    this._validatorSetValue("7", props.pv1_7 || props.attendingDoctor, {
      length: { min: 1, max: 60 },
    });
    this._validatorSetValue("8", props.pv1_8 || props.referringDoctor, {
      length: { min: 1, max: 60 },
    });
    this._validatorSetValue("9", props.pv1_9 || props.consultingDoctor, {
      length: { min: 1, max: 60 },
    });
    this._validatorSetValue("10", props.pv1_10 || props.hospitalService, {
      length: { min: 1, max: 3 },
    });
    this._validatorSetValue("11", props.pv1_11 || props.temporaryLocation, {
      length: { min: 1, max: 12 },
    });
    this._validatorSetValue("12", props.pv1_12, { length: 2 });
    this._validatorSetValue("13", props.pv1_13, { length: 2 });
    this._validatorSetValue("14", props.pv1_14 || props.admitSource, {
      length: 1,
    });
    this._validatorSetValue("15", props.pv1_15 || props.ambulatoryStatus, {
      length: 2,
    });
    this._validatorSetValue("16", props.pv1_16 || props.vipIndicator, {
      length: 2,
    });
    this._validatorSetValue("17", props.pv1_17 || props.admittingDoctor, {
      length: { min: 1, max: 60 },
    });
    this._validatorSetValue("18", props.pv1_18 || props.patientType, {
      length: 2,
    });
    this._validatorSetValue("19", props.pv1_19 || props.visitNumber, {
      length: { min: 1, max: 15 },
    });
    this._validatorSetValue("20", props.pv1_20 || props.financialClass, {
      length: { min: 1, max: 50 },
    });
    this._validatorSetValue("21", props.pv1_21, { length: 2 });
    this._validatorSetValue("22", props.pv1_22, { length: 2 });
    this._validatorSetValue("23", props.pv1_23, { length: 2 });
    this._validatorSetValue("24", props.pv1_24, { length: 2 });
    this._validatorSetValue(
      "25",
    ...
    this._validatorSetValue("26", props.pv1_26, {
      length: { min: 1, max: 12 },
    });
    this._validatorSetValue("27", props.pv1_27, {
      length: { min: 1, max: 3 },
    });
    this._validatorSetValue("28", props.pv1_28, { length: 2 });
    this._validatorSetValue("29", props.pv1_29, { length: 4 });
    this._validatorSetValue(
      "30",
    ...
    this._validatorSetValue("31", props.pv1_31, {
      length: { min: 1, max: 10 },
    });
    this._validatorSetValue("32", props.pv1_32, {
      length: { min: 1, max: 12 },
    });
    this._validatorSetValue("33", props.pv1_33, {
      length: { min: 1, max: 12 },
    });
    this._validatorSetValue("34", props.pv1_34, { length: 3 });
    this._validatorSetValue(
      "35",
    ...
    this._validatorSetValue("36", props.pv1_36 || props.dischargeDisposition, {
      length: 3,
    });
    this._validatorSetValue("37", props.pv1_37, {
      length: { min: 1, max: 25 },
    });
    this._validatorSetValue("38", props.pv1_38, {
      length: { min: 1, max: 2 },
    });
    this._validatorSetValue("39", props.pv1_39, {
      length: { min: 1, max: 2 },
    });
    this._validatorSetValue("40", props.pv1_40 || props.bedStatus, {
      allowedValues: this._table_0116,
      length: 1,
    });
    this._validatorSetValue("41", props.pv1_41, {
      length: { min: 1, max: 2 },
    });
    this._validatorSetValue("42", props.pv1_42, {
      length: { min: 1, max: 12 },
    });
    this._validatorSetValue("43", props.pv1_43, {
      length: { min: 1, max: 12 },
    });
    this._validatorSetValue(
      "44",
  ...
  protected _buildPR1(props: Partial<HL7_2_1_PR1>) {
    ...
    this._validatorSetValue("1", props.pr1_1, {
      required: true,
      length: { min: 1, max: 4 },
    });
    this._validatorSetValue(
    ...
    this._validatorSetValue("3", props.pr1_3 || props.procedureCode, {
      required: true,
      length: { min: 1, max: 10 },
    });
    this._validatorSetValue(
    ...
    this._validatorSetValue("6", props.pr1_6 || props.procedureType, {
      length: 2,
    });
    this._validatorSetValue("7", props.pr1_7 || props.procedureMinutes, {
      length: { min: 1, max: 4 },
    });
    this._validatorSetValue("8", props.pr1_8 || props.anesthesiologist, {
      length: { min: 1, max: 60 },
    });
    this._validatorSetValue("9", props.pr1_9 || props.anesthesiaCode, {
      length: { min: 1, max: 2 },
    });
    this._validatorSetValue(
      "10",
    ...
    this._validatorSetValue("11", props.pr1_11 || props.surgeon, {
      length: { min: 1, max: 60 },
    });
  }
  ...
  protected _buildQRD(props: Partial<HL7_2_1_QRD>) {
    ...
    this._validatorSetValue("3", props.qrd_3 || props.queryPriority, {
      required: true,
      length: 1,
    });
    this._validatorSetValue("4", props.qrd_4 || props.queryId, {
      required: true,
      length: { min: 1, max: 10 },
    });
    this._validatorSetValue(
    ...
    this._validatorSetValue("8", props.qrd_8 || props.whoSubjectFilter, {
      required: true,
      length: { min: 1, max: 20 },
    });
    this._validatorSetValue("9", props.qrd_9 || props.whatSubjectFilter, {
      required: true,
      length: { min: 1, max: 3 },
    });
    this._validatorSetValue(
  ...
  protected _buildQRF(props: Partial<HL7_2_1_QRF>) {
    ...
    this._validatorSetValue("4", props.qrf_4 || props.whatUserQualifier, {
      length: { min: 1, max: 20 },
    });
    this._validatorSetValue(
      "5",
  ...
  protected _buildRX1(props: Partial<HL7_2_1_RX1>) {
    ...
    this._validatorSetValue("1", props.rx1_1, { length: { min: 1, max: 40 } });
    this._validatorSetValue("2", props.rx1_2 || props.giveCode, {
      required: true,
    ...
    this._validatorSetValue("5", props.rx1_5 || props.giveUnits, {
      length: { min: 1, max: 60 },
    });
    this._validatorSetValue("6", props.rx1_6 || props.giveDosageForm, {
      length: { min: 1, max: 60 },
    });
    this._validatorSetValue(
      "7",
    ...
    this._validatorSetValue("9", props.rx1_9 || props.deliverToLocation, {
      length: { min: 1, max: 200 },
    });
    this._validatorSetValue("10", props.rx1_10 || props.allowSubstitutions, {
      length: { min: 1, max: 1 },
    });
    this._validatorSetValue("11", props.rx1_11 || props.requestedGiveCode, {
      length: { min: 1, max: 100 },
    });
    this._validatorSetValue(
      "12",
    ...
    this._validatorSetValue("17", props.rx1_17 || props.givePer, {
      length: { min: 1, max: 20 },
    });
    this._validatorSetValue("18", props.rx1_18 || props.giveRateAmount, {
      length: { min: 1, max: 6 },
    });
    this._validatorSetValue("19", props.rx1_19 || props.giveRateUnits, {
      length: { min: 1, max: 60 },
    });
    this._validatorSetValue("20", props.rx1_20, {
      length: { min: 1, max: 6 },
    });
    this._validatorSetValue("21", props.rx1_21, {
      length: { min: 1, max: 60 },
    });
    this._validatorSetValue("22", props.rx1_22 || props.totalDailyDose, {
      length: { min: 1, max: 10 },
    });
  }
  ...
  protected _buildUB1(props: Partial<HL7_2_1_UB1>) {
    ...
    this._validatorSetValue("1", props.ub1_1, { length: { min: 1, max: 4 } });
    this._validatorSetValue("2", props.ub1_2 || props.bloodDeductible, {
      length: { min: 1, max: 1 },
    });
    this._validatorSetValue("3", props.ub1_3 || props.bloodFurnishedPints, {
      length: { min: 1, max: 2 },
    });
    this._validatorSetValue("4", props.ub1_4 || props.bloodReplacedPints, {
      length: { min: 1, max: 2 },
    });
    this._validatorSetValue(
      "5",
    ...
    this._validatorSetValue("6", props.ub1_6 || props.coInsuranceDays, {
      length: { min: 1, max: 2 },
    });
    this._validatorSetValue("7", props.ub1_7 || props.conditionCode, {
      length: { min: 1, max: 14 },
    });
    this._validatorSetValue("8", props.ub1_8 || props.coveredDays, {
      length: { min: 1, max: 3 },
    });
    this._validatorSetValue("9", props.ub1_9 || props.nonCoveredDays, {
      length: { min: 1, max: 3 },
    });
    this._validatorSetValue("10", props.ub1_10 || props.valueAmountCode, {
      length: { min: 1, max: 55 },
    });
    this._validatorSetValue("11", props.ub1_11 || props.numberOfGraceDays, {
      length: { min: 1, max: 2 },
    });
    this._validatorSetValue(
      "12",
    ...
    this._validatorSetValue("13", props.ub1_13, { length: 2 });
    this._validatorSetValue(
      "14",
    ...
    this._validatorSetValue("16", props.ub1_16 || props.occurrence, {
      length: { min: 1, max: 20 },
    });
    this._validatorSetValue("17", props.ub1_17 || props.occurrenceSpan, {
      length: { min: 1, max: 2 },
    });
    this._validatorSetValue(
      "18",
    ...
    this._validatorSetValue("20", props.ub1_20, {
      length: { min: 1, max: 30 },
    });
    this._validatorSetValue("21", props.ub1_21, {
      length: { min: 1, max: 7 },
    });
    this._validatorSetValue("22", props.ub1_22, {
      length: { min: 1, max: 8 },
    });
    this._validatorSetValue("23", props.ub1_23, {
      length: { min: 1, max: 17 },
    });
  }
  ...
  protected _buildURD(props: Partial<HL7_2_1_URD>) {
    ...
    this._validatorSetValue("2", props.urd_2 || props.reportPriority, {
      length: 1,
    });
    this._validatorSetValue(
      "3",
  ...
  protected _buildURS(props: Partial<HL7_2_1_URS>) {
    ...
    this._validatorSetValue("4", props.urs_4 || props.ruWhatUserQualifier, {
      length: { min: 1, max: 20 },
    });
    this._validatorSetValue("5", props.urs_5, {
      length: { min: 1, max: 20 },
    });
    this._validatorSetValue("6", props.urs_6, {
      length: { min: 1, max: 12 },
    });
  }
}
