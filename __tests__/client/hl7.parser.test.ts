...
describe("hl7 parser tests", () => {
  describe("field separations", () => {
    test("parses repeating PID.3 with multiple identifier types", () => {
    ...
    test("parses repeating PID.3 with namespace identifiers", () => {
    ...
    test("parses repeating PID.3 across LF-separated segments", () => {
